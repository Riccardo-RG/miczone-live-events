...
import miczoneLogo from "../images/miczonelogo.png";
  ...
  return (
    <nav
      className={cn(
        ...
        isScrolled
          ? "bg-miczone-black/90 backdrop-blur-md shadow-md"
          : "bg-transparent"
      )}
    >
      <div className="container-custom flex items-center justify-between">
        <div className="flex items-center">
          <img src={miczoneLogo} alt="Miczone Logo" className="h-12 w-auto" />
        </div>
